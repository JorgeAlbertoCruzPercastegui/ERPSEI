		...
		private static void BuildConciliaciones(ModelBuilder b) 
		{
            ...
            b.Entity<Banco>()
                .HasData(
                    ...
                    new Banco() { Id = 15, Nombre = "Bx" },
                    new Banco() { Id = 16, Nombre = "Cibanco" },
                    new Banco() { Id = 17, Nombre = "Citibanamex" },
					new Banco() { Id = 18, Nombre = "Eplata" },
					new Banco() { Id = 19, Nombre = "Fortuna" },
                    new Banco() { Id = 20, Nombre = "HSBC" },
                    new Banco() { Id = 21, Nombre = "Inbursa" },
                    new Banco() { Id = 22, Nombre = "Intercam" },
                    new Banco() { Id = 23, Nombre = "Invex" },
                    new Banco() { Id = 24, Nombre = "Jeeves" },
					new Banco() { Id = 25, Nombre = "KLU" },
					new Banco() { Id = 26, Nombre = "Konfio" },
                    new Banco() { Id = 27, Nombre = "Mercado Pago" },
                    new Banco() { Id = 28, Nombre = "Mifel" },
                    new Banco() { Id = 29, Nombre = "Monex" },
                    new Banco() { Id = 30, Nombre = "Multiva" },
					new Banco() { Id = 31, Nombre = "PayMax" },
					new Banco() { Id = 32, Nombre = "Santander" },
                    new Banco() { Id = 33, Nombre = "Scotiabank" },
					new Banco() { Id = 34, Nombre = "SantanderDig" }
